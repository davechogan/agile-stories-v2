...
console.log('Mock data:', mockTechReviewResult)
console.log('Implementation details:', mockTechReviewResult.implementation_details)
console.log('Available details:', availableDetails.value)
</script>
...
.risk-item.medium { border-left-color: #FFA726; }
.risk-item.low { border-left-color: #66BB6A; }
